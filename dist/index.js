    ...
    var ToolRunner2 = class extends events2.EventEmitter {
      ...
      exec() {
        return __awaiter11(this, void 0, void 0, function* () {
          ...
          return new Promise((resolve2, reject) => __awaiter11(this, void 0, void 0, function* () {
            this._debug(`exec tool: ${this.toolPath}`);
            this._debug("arguments:");
            for (const arg of this.args) {
              this._debug(`   ${arg}`);
...
async function run() {
  try {
    ...
    if (settings_1.Inputs.stamp) {
      if (path6.basename(settings_1.Inputs.stamp) === "package.json") {
        await (0, exec_1.exec)("npm", ["version", versionProperties.NpmPackageVersion, "--git-tag-version=false", "--allow-same-version"], { cwd: path6.dirname(settings_1.Inputs.stamp) });
      } else {
        throw new Error(`Unable to stamp unsupported file format: ${path6.basename(settings_1.Inputs.stamp)}`);
      }
    }
  } catch (error2) {
