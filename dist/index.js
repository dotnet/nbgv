...
var require_io = __commonJS({
  "node_modules/@actions/core/node_modules/@actions/io/lib/io.js"(exports2) {
    ...
    var path5 = __importStar2(require("path"));
    var ioUtil2 = __importStar2(require_io_util());
    ...
    function findInPath(tool) {
      return __awaiter9(this, void 0, void 0, function* () {
        ...
        for (const directory of directories) {
          const filePath = yield ioUtil2.tryGetExecutablePath(path5.join(directory, tool), extensions);
          if (filePath) {
...
var os3, events, child, path2, io, ioUtil, import_timers, __awaiter5, IS_WINDOWS, ToolRunner, ExecState;
var init_toolrunner = __esm({
  "node_modules/@actions/core/node_modules/@actions/exec/lib/toolrunner.js"() {
    ...
    io = __toESM(require_io(), 1);
    ioUtil = __toESM(require_io_util(), 1);
...
var os5, path3, __awaiter8, ExitCode;
var init_core = __esm({
  "node_modules/@actions/core/lib/core.js"() {
    init_command();
    init_file_command();
...
var require_io2 = __commonJS({
  "node_modules/@actions/exec/node_modules/@actions/io/lib/io.js"(exports2) {
    ...
    var assert_1 = require("assert");
    var path5 = __importStar2(require("path"));
    var ioUtil2 = __importStar2(require_io_util2());
    function cp(source, dest, options = {}) {
      return __awaiter9(this, void 0, void 0, function* () {
        const { force, recursive, copySourceDirectory } = readCopyOptions(options);
        const destStat = (yield ioUtil2.exists(dest)) ? yield ioUtil2.stat(dest) : null;
...
var require_toolrunner = __commonJS({
  "node_modules/@actions/exec/lib/toolrunner.js"(exports2) {
    ...
    var events2 = __importStar2(require("events"));
    var child2 = __importStar2(require("child_process"));
    var path5 = __importStar2(require("path"));
    ...
    var ToolRunner2 = class extends events2.EventEmitter {
      ...
      exec() {
        return __awaiter9(this, void 0, void 0, function* () {
          if (!ioUtil2.isRooted(this.toolPath) && (this.toolPath.includes("/") || IS_WINDOWS2 && this.toolPath.includes("\\"))) {
          ...
          return new Promise((resolve2, reject) => __awaiter9(this, void 0, void 0, function* () {
            this._debug(`exec tool: ${this.toolPath}`);
            this._debug("arguments:");
            for (const arg of this.args) {
              this._debug(`   ${arg}`);
...
var require_settings = __commonJS({
  "lib/settings.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Inputs = void 0;
    var core2 = __importStar2((init_core(), __toCommonJS(core_exports)));
    var Inputs = class {
      static get path() {
        const result = core2.getInput("path");
        return result === "" || result === null ? void 0 : result;
      }
      static get stamp() {
        const result = core2.getInput("stamp");
        return result === "" || result === null ? void 0 : result;
      }
      static get setAllVars() {
        return core2.getInput("setAllVars") === "true";
      }
      static get setCommonVars() {
        return core2.getInput("setCommonVars") === "true";
      }
      static get toolVersion() {
        const result = core2.getInput("toolVersion");
        return result === "" || result === null ? void 0 : result;
      }
      static get toolFeed() {
        const result = core2.getInput("toolFeed");
        return result === "" || result === null ? void 0 : result;
      }
    };
...
async function run() {
  try {
    ...
    let versionJson = "";
    await (0, exec_1.exec)("dotnet", [...baseArgs, ...args], { listeners: { stdout: (data) => {
    ...
    if (settings_1.Inputs.stamp) {
      if (path4.basename(settings_1.Inputs.stamp) === "package.json") {
        await (0, exec_1.exec)("npm", ["version", versionProperties.NpmPackageVersion, "--git-tag-version=false", "--allow-same-version"], { cwd: path4.dirname(settings_1.Inputs.stamp) });
      } else {
        throw new Error(`Unable to stamp unsupported file format: ${path4.basename(settings_1.Inputs.stamp)}`);
      }
    }
  } catch (error2) {
